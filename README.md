...
`web/` 配下に Apple 製品のようなミニマル UI を備えたデモダッシュボードを追加しました。プレイヤーの参加/準備、ゲーム開始、カードプレイ、ログ確認をブラウザから直感的に行えます。
...
組み込みのライトウェイトサーバーが `http://localhost:4173` で立ち上がります。ブラウザでアクセスし、デモプレイヤーを投入するだけでカード配布からターン操作までを確認できます。
